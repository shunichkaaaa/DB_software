...
<p style="text-align:justify">Без HTTPS будь-які передані дані не є безпечними. Це особливо важливо для сайтів, де через з'єднання передаються важливі дані, такі як сайти електронної комерції, які приймають онлайн-платежі карткою, або вікна входу, де користувачам потрібно вводити свої облікові дані.</p>
